package MATCodeNewbies2020.drawMagicSquare;

/**
 * drawMagicSquare
 */
public class drawMagicSquare {
    public int[][] drawMagicSquare(int[] bottomLeft, int[] topRight) {
        ...
        double a = getDistanceEuclidian(bottomLeft, bottomRight), b = getDistanceEuclidian(bottomRight, topRight),
                c = getDistanceEuclidian(topRight, topLeft), d = getDistanceEuclidian(topLeft, bottomLeft);
